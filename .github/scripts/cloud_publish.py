...
TAG_MAP = {
    'rebate': 'Rebates & Grants', 'grant': 'Rebates & Grants', 'fema grant': 'Rebates & Grants',
    'cost': 'Cost & Pricing', 'price': 'Cost & Pricing', 'financing': 'Cost & Pricing', 'tax': 'Cost & Pricing',
    'above-ground': 'Above-Ground Safe Rooms', 'above ground': 'Above-Ground Safe Rooms', 'safe room': 'Above-Ground Safe Rooms',
    'underground': 'Underground Shelters', 'bunker': 'Underground Shelters',
    'garage': 'Garage Shelters', 'in-floor': 'Garage Shelters',
    'commercial': 'Commercial Shelters', 'community': 'Commercial Shelters',
    'fema': 'Engineering & Standards', 'icc-500': 'Engineering & Standards', 'ef5': 'Engineering & Standards',
    'wind load': 'Engineering & Standards', 'anchor': 'Engineering & Standards', 'material': 'Engineering & Standards',
    'steel vs concrete': 'Engineering & Standards', 'testing': 'Engineering & Standards',
    'permit': 'Permits & Codes', 'code': 'Permits & Codes', 'inspection': 'Permits & Codes', 'register': 'Permits & Codes',
    'insurance': 'Home Value & Insurance', 'resale': 'Home Value & Insurance', 'home value': 'Home Value & Insurance', 'roi': 'Home Value & Insurance',
    'sherman': 'Local Texoma Guides', 'denison': 'Local Texoma Guides', 'pottsboro': 'Local Texoma Guides',
    'whitesboro': 'Local Texoma Guides', 'van alstyne': 'Local Texoma Guides', 'gunter': 'Local Texoma Guides',
    'maintenance': 'Preparedness', 'prep': 'Preparedness', 'kit': 'Preparedness', 'ventilation': 'Preparedness',
    'pet': 'Preparedness', 'comfort': 'Preparedness', 'power outage': 'Preparedness', 'water in': 'Preparedness',
}
...
def make_nav_title(title):
    ...
    nav = re.sub(r'\s*[-–—]\s*Texoma Storm Shelters.*$', '', nav)
    nav = re.sub(r'\s*\(20\d{2}.*?\)', '', nav)
    nav = re.sub(r'\s*(Sherman|Denison|Texoma):?\s*', ' ', nav, flags=re.I).strip()
    if len(nav) <= 30:
        return nav
    words = nav.split()
    result = ''
